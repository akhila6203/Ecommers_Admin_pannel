...
export const navColorPresets = [
  { id: "clean-white", name: "Clean White", bg: "0 0% 100%", foreground: "20 14% 20%", accent: "30 30% 96%", accentForeground: "20 14% 12%", border: "30 15% 90%", muted: "20 9% 46%", preview: "#ffffff" },
...
export function UICustomizationProvider({ children }) {
  const [colorPreset, setColorPresetState] = useState(
    () => localStorage.getItem("ui-color") || "amber"
  );
  ...
  const [navColorPreset, setNavColorPresetState] = useState(
    () => localStorage.getItem("ui-nav-color") || "clean-white"
  );
